...
BEGIN_MESSAGE_MAP(CTutorial1App, CWinAppEx)
	ON_COMMAND(ID_APP_ABOUT, &CTutorial1App::OnAppAbout)
END_MESSAGE_MAP()
...
CTutorial1App::CTutorial1App()
{
	...
	SetAppID(_T("Tutorial1.AppID.NoVersion"));
...
int CTutorial1App::ExitInstance()
{
...
// CTutorial1App message handlers
