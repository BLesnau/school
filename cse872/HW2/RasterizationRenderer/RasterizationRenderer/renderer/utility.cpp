...
{	
   ...
   for (int j = 0; j < num; j++) 
   {
      ...
      case GZ_COLOR:
         {
            (*( (GzColor*) (fragment_input_list[j])))[0] = (*((GzColor*) (list[0][j])))[0] * eNorm[0];
            (*( (GzColor*) (fragment_input_list[j])))[0] += (*((GzColor*) (list[1][j])))[0] * eNorm[1];
            (*( (GzColor*) (fragment_input_list[j])))[0] += (*((GzColor*) (list[2][j])))[0] * eNorm[2];

            (*( (GzColor*) (fragment_input_list[j])))[1] = (*((GzColor*) (list[0][j])))[1] * eNorm[0];
            (*( (GzColor*) (fragment_input_list[j])))[1] += (*((GzColor*) (list[1][j])))[1] * eNorm[1];
            (*( (GzColor*) (fragment_input_list[j])))[1] += (*((GzColor*) (list[2][j])))[1] * eNorm[2];
